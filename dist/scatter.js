    ...
    handleMouseEvent1(response)
      ...
      function handleMouseEvent1 (response) {
        if (response.index == 1){
            ...
            figure2.select("#figure_caption")
                .html(`<br>
                For anyone serious about opting out of Minerva housing and curious about what Airbnb options look like, click on each bubble to get to the listing page. The Quest also scraped the ratings from these listings. Use the legend below to note which cities have more listings, and which of these are not too sus given their ratings. <br>
